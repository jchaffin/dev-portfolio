...

{
  ...
  "properties": {
    "rationale": {
      "type": "string",
      "description": "Short description explaining the decision"
    },
    "userRequest": {
      "type": "string", 
      "description": "The user's desired outcome or action"
    },
    "isEligible": {
      "type": "string",
      "enum": ["true", "false", "need_more_information"],
      "description": "true if confident given context, need_more_information if additional info needed"
    },
    "additionalInformationNeeded": {
      "type": "string",
      "description": "Other information needed to make a clear determination. Can be 'None'"
    },
    "returnNextSteps": {
      "type": "string",
      "description": "Next steps explanation. Only if isEligible=true, otherwise 'None'"
    }
  },
  "required": ["rationale", "userRequest", "isEligible", "additionalInformationNeeded", "returnNextSteps"]
}  
`,
          },
        ];
